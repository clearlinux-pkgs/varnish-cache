...
Version  : 6.2.1
Release  : 5
URL      : https://github.com/varnishcache/varnish-cache/archive/varnish-6.2.1/varnish-cache-6.2.1.tar.gz
Source0  : https://github.com/varnishcache/varnish-cache/archive/varnish-6.2.1/varnish-cache-6.2.1.tar.gz
Summary  : Varnish API
...
Requires: varnish-cache = %{version}-%{release}
Requires: varnish-cache = %{version}-%{release}
...
%prep
%setup -q -n varnish-cache-varnish-6.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567653558
