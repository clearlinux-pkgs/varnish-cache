...
Version  : 6.2.0
Release  : 4
URL      : https://github.com/varnishcache/varnish-cache/archive/varnish-6.2.0.tar.gz
Source0  : https://github.com/varnishcache/varnish-cache/archive/varnish-6.2.0.tar.gz
Summary  : Varnish API
...
%prep
%setup -q -n varnish-cache-varnish-6.2.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1552668106
