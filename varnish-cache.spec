...
Version  : 6.0.1
Release  : 1
URL      : https://github.com/varnishcache/varnish-cache/archive/varnish-6.0.1.tar.gz
Source0  : https://github.com/varnishcache/varnish-cache/archive/varnish-6.0.1.tar.gz
Summary  : Varnish API
...
%prep
%setup -q -n varnish-cache-varnish-6.0.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1536800411
